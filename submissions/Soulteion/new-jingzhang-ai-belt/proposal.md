...
**本方案的公共底线只有一句**：任何 AI 场景，都必须在智能层关闭后仍能获得同一项基础服务。人工窗口、纸本、电话与固定导视先于智能层存在，智能层才有资格打开；拒绝智能不得导致排队延后、加价或服务降级 [standard:BARRIER-FREE-ENVIRONMENT-LAW] [standard:ELDERLY-SMART-TECH-PLAN-2020-45] [depth:scenario_open_operation]。
...
该表为设计需求夹具，不是真实用户测试结论；真实参与观察与通过记录均为 0，待场地授权后由无障碍专业人员主持共测，以观测结果替换夹具 [depth:scenario_open_operation] [standard:BARRIER-FREE-ENVIRONMENT-LAW]。
