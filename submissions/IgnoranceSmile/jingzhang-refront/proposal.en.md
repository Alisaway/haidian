---
title: "JINGZHANG RE:FRONT / 京张·复面"
...
![A Corridor of Fronts | Overall Scroll](assets/figures/site-overview.en.png)
...
![Turn the Ground Floor to the Park](assets/figures/land-use-structure.en.png)
...
![One Civic Spine, Three Fronts](assets/figures/key-areas.en.png)
...
![Cross Only with Cause | Cross Streets, Stations, and Logistics Determine the Handoff](assets/figures/mobility-bluegreen.en.png)
...
![Hold the Baseline, Then Open | The Non-Regression Ledger](assets/figures/metrics-evidence.en.png)
