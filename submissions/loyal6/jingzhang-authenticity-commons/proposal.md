...
现有RACI概览展开为授权、受理、暂停、独立复核、同渠道更正、产品重测、数据场地恢复、采用/修改/退役八个动作；每项只有一个最终负责角色，另列执行、咨询和知会角色。原发布者、供应商及材料制作人不能独立复核本案。两个原渠道分别填写旧新版本、暂停与更正时间、签收人和证据引用；遗漏或未签收都保持暂停。参见[可填写执行附件](visual/index.html#execution) [data:visual/assets/execution-contract.json#raci]。
