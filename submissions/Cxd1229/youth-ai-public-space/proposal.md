...
**工作重点**：识别海淀高校资源（北大、清华、北航、北邮等十余所高校）与AI产业（中关村软件园、后厂村、智源研究院）的空间关系，分析青年人才（海淀区IT业在岗职工53.5万人、科研业20.0万人 [source:HAIDIAN-YEARBOOK-2021-2024]；高校在校生约35万人（概念推断，基于北京市教育统计与海淀高校分布，非项目范围实测值））的日常活动轨迹，提出区域级公共空间与创新服务网络。
...
| 绿地与开放空间 | 12.5% | 142.9 | 京张遗址公园+口袋公园网络 |
| 公共服务设施 | 10% | 114 | 24小时图书馆、运动中心、社区食堂 |
| 道路交通设施 | 8% | 91.2 | 加密次干路与支路网 |
| 文化设施与遗产 | 5% | 57 | 铁路博物馆+创新展厅+荣誉墙节点 |
| 混合弹性用地 | 5% | 57 | 预留AI测试场景与临时活动 |

> 上表为概念性用地功能分区；绿地与开放空间面积以 `geometry/green_space.geojson` 实测 142.9ha 为权威口径（对应绿地率 12.5%），分区面积与 site_boundary 实测 1142.7ha 存在概念归类口径差异，空间复算以 GeoJSON 为准 [data:geometry/land_use.geojson]。
...
- AI算力中心的PUE目标≤1.2（概念目标，参照北京市数据中心能效要求，待专业测算确认，非现状承诺）
