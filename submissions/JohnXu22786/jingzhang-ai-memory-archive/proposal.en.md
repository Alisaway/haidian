---
title: "Jing-Zhang Memory · AI Archive Gallery"
author_github: "JohnXu22786"
language: "en"
translation_of: "proposal.md"
proposal_format_version: "2"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "A traceable, withdrawable and human-reviewed concept infrastructure linking Jing-Zhang memory, AI evidence and continuous public space."
...
![Overall design overview: provisional boundary, three key areas, green space, public space and memory nodes](assets/figures/site-overview.en.png)
...
![Mobility and blue-green public space: three Proof-Memory Loops and reversible nodes](assets/figures/mobility-bluegreen.en.png)
...
![Key-area relationship: AI Origin Community, Zhongzhi Park accelerator and Dazhongsi industry cluster](assets/figures/key-areas.en.png)
...
![Land-use and building structure: conceptual zones, retain-renovate-demolish strategy and provisional areas](assets/figures/land-use-structure.en.png)
...
![Core metric evidence: area, green space, public space and scenario-task calculation rules](assets/figures/metrics-evidence.en.png)
