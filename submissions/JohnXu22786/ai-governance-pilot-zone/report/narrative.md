...
REPAIR ROUND-2 (2026-08-30): 根据最新 CocoSgt 82/100 CHANGES_REQUESTED 官评，补齐品牌在先权利初步筛查记录与中英权利边界；将来源锚点绑定到 sources.json 的实际 source_id，收窄阿姆斯特丹案例表述；新增大钟寺智能原生消费/商务场景卡⑬及 agent.4 映射；把撤收改成许可、人员、运输、组件数量、工时、场地、废弃物和复绿验收前提下的概念目标；重排范围卡、节点卡和英文指标表并重生成双语图件、HTML、A3/A0 PDF。所有名称仍为内部工作代号，初步筛查不等同法律清查；PR 保持 Draft，未推送、未触发 Ready。
