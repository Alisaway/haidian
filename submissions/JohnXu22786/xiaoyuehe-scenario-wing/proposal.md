...
交通组织以慢行为先：沿河贯通约3公里滨水步道与骑行道，消除现状断点，桥下空间改造为通道与停留点；与周边轨道站点建立5—10分钟可达接驳（轨道接驳对象为待核验的概念节点名称，本方案不对外给出具体站名；接驳服务半径、时距与可达性为概念设想，待组织方或官方发布站点信息后复算），优化公交站点位置，在廊道端点与广场周边设置共享单车与远端停车场，限制机动车进入滨水区。市政设施结合生态修复一体化设计：河道补水与水质净化、海绵雨水设施、雨污分流改造；照明、强弱电与给排水均预留模块化接口，便于场景设施快速接入；全部设施以防洪与水位校核为前置专业校核项，本方案不预断结论。公共服务设施按每500米服务半径配置驿站、无障碍卫生间、母婴室、饮水点与AED应急点，节点建筑兼具避雨、寄存与运维功能。面向视听障碍与低数字技能用户，设置纸质导览、人工接待、求助按钮与停服后人工替代，确保数字服务与人工服务并行，形成「看得懂、找得到、用得上」的全龄无障碍公共体验路径。轨道站点信息核验边界：本方案引用的轨道站点名仅作为概念接驳对象，不构成对站点位置、命名、运营主体或接驳距离的事实主张；任何轨道站名、线路名、站间距、班次密度均以组织方/运营方后续发布的可核验官方数据为准。
...
| 类别 | 名称 | 来源（发布者） | 出版/访问日期 | 许可 | 允许用途 | 引用范围 |
| --- | --- | --- | --- | --- | --- | --- |
