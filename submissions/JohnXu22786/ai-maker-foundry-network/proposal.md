...
总体概念命名为“CRAFT-JZ 众智AI创客家坊网络”。“CRAFT”强调把模型、硬件、知识和公共服务做成可交付原型，“JZ”只作为百年京张语境下的工作识别，不冒充组织方或既有城市品牌。视觉识别采用自绘四格“间”字模数：四个开口代表旗舰家坊、社区工坊、街角Lab和开放实验床，陶土橙表示造物，钢轨蓝表示记忆，AI靛表示协作。Logo方向、字体、版权、商标和最终命名仍需检索与授权确认。
...
风貌叙事采用三段步行故事：第一段“铁轨记忆”讲述京张铁路作为近代工程与公共记忆的历史线索，事实表述以可核验来源为准；第二段“中关村造物”讲述开放知识、工程实践和问题导向的创新文化，不挪用企业标志；第三段“AI共创日常”展示模型、工具和公共服务如何被人理解、纠错和退出。导视系统与CRAFT-JZ整体Logo分层使用，文化符号不混入官方品牌；所有图像、字体、人物、商标和历史图片均需授权或使用自产替代。
...
三项核心视觉指标必须来自本包几何并可重算：site_area_sqm = site_boundary投影面积；green_ratio = green_space与site_boundary的并集面积 / site_boundary面积；public_space_ratio = public_space与site_boundary的并集面积 / site_boundary面积。当前值分别为约11,412,825.386平方米、0.123423和0.073281，均为参与方 provisional 模型值，不是官方面积、红线或现状统计。visual/index.html和metrics.json使用同一组数值 data-value，并附来源文件、公式、置信度、假设和复算触发条件。FAR、建筑高度、用地权属、运营基线、投资和容量维持 unknown/null，因为官方控制条件或基线未提供。
...
风险处置采用“发现-停用-告知-复核-退出”：安全、隐私、偏差、版权、文保、无障碍、权属、预算或投诉达到停止条件时，运营方立即切换人工或纸面服务，保留最小审计记录，向受影响参与者告知，交由独立复核，并撤下或回滚相关原型。权利台账覆盖正文、英文翻译、四份PDF、十二组图件、HTML、几何、字体、来源记录和生成方法；自绘材料由本包作者创作，第三方来源只作引用或机制参照，未授权Logo、人物、图片、字体和论文图像不嵌入。CRAFT-JZ为工作识别名，商标可用性未确认，正式传播前须完成检索、权利清理和人工批准。
