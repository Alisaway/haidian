---
title: AI Maker Foundry Network CRAFT-JZ
...
license: CC-BY-4.0
summary: A provisional AI maker and builder network organized by three zones, two wings, three nodes, and an open testbed.
---
...
![Overview of one spine, three foundries, two wings, and three concept nodes with a provisional boundary](assets/figures/site-overview.en.png)
...
![Relationship between three scopes, three zones, two wings, and three concept nodes](assets/figures/key-areas.en.png)
...
![Conceptual compatibility map for land and space, not a statutory land-use plan](assets/figures/land-use-structure.en.png)
...
![Concept loop for walking, rail connection, blue-green space, and staffed fallback](assets/figures/mobility-bluegreen.en.png)
...
The walking story has three parts: “rail memory” presents the Jing-Zhang Railway as a modern engineering and public-memory thread, using verifiable history; “Zhongguancun making” presents open knowledge and problem-led engineering without borrowing corporate marks; “AI in everyday co-creation” shows how models, tools, and public services can be understood, corrected, and withdrawn. The culture system is separate from the CRAFT-JZ identity system. Images, fonts, people, trademarks, and historical photographs require permission or package-authored substitutes.
...
The three formal visual indicators come from package geometry: site_area_sqm is the projected area of site_boundary; green_ratio is the union of green_space polygons divided by site_boundary area; public_space_ratio is the union of public_space polygons divided by site_boundary area. Current values are about 11,412,825.386 sqm, 0.123423, and 0.073281. They are provisional participant model values, not official areas, redlines, or existing-condition statistics. visual/index.html and metrics.json use the same numeric data-value declarations and list source files, formulas, confidence, assumptions, and recomputation triggers. FAR, height, ownership, operating baseline, investment, and capacity remain unknown or null because official controls or baselines are absent.
...
![Evidence panel for the three core visual metrics, sources, formulas, confidence, and recomputation trigger](assets/figures/metrics-evidence.en.png)
