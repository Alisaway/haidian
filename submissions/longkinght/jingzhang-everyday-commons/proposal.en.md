...
### Five functions × 64K translations

| Function and spatial anchor | 64K concept line | Public interface in the three-station, five-segment system |
|---|---|---|
| AI foundational research and original innovation · Zhongzhiyuan | The first line of code from zero to one | Evidence workshop, controlled tests, failure records and reusable rules |
| AI talent community and translation · AI Origin Community | The first executable program inside 64KB | Learning commons, care entrance and a low-digital-barrier first use |
| AI industry clustering and market landing · Dazhongsi | Package the demo into a product | First-use concourse, enterprise service, public consumption and review |
| Technology service and global links · Zhongguancun Service Wing | Driver and API | Bilingual evidence briefs and interfaces for knowledge and IP translation |
| AI scene enablement and public experience · Xiaoyuehe Wing + Heritage Park | 64 pixels compose a first digital image | Daily walking, cultural guidance, public experience and an equivalent human path |

These concept lines name spatial experiences and narrative cues; they do not add engineering metrics. They make the five open-call functions visible, usable and reviewable in public space.


## Identity and Public Interface

The identity is consistently **64K × JINGZHANG**, supported by **One bus, two openings**. The participant-supplied mark lets an orange railway track and a cyan digital track converge into the K, making the dual-origin superposition legible at a glance. Two continuous service paths share one public base: signal orange represents the human/offline path, safe cyan represents the AI-advice path, and carbon black holds the common infrastructure. A visible switch-node makes human choice and traceable rollback legible. The mark, type and colors remain a concept direction pending participant rights and final authorization [source:SRC-2026-0518-AGENT-OPEN-CALL-TASKBOOK].
