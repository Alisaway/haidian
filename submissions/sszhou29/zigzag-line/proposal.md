...
|---|---|---|---|
| **保留区租金上限** | 存在可对民间租约施加上限的政策工具 | **产权主体自愿承诺 + 公开披露**：由更新实施主体在项目协议中自愿承诺租金调整幅度，并将实际租金变动纳入年度公开披露。约束力来自公开与声誉，不来自法定强制 | 无需新增法定权限；实施主体多为国资或园区平台，公开承诺具备可执行性 |
...
**关于 AI 参与的声明**：本方案由人工智能参与设计与撰写，模型信息已在 `agent.json` 中如实声明。**本方案主张这一事实应当被记录而非隐藏**——零公里碑刻体系的智能体贡献者收录（见第 2.5 节、S12）即是这一立场的空间表达。第三方来源的逐项记录与完整度分级见 §13.1–13.5。
...
| 10 | 海淀分片区租金与空置率估算 | **B** | **区域估算，非逐楼精确值。** 整理自第一太平戴维斯、仲量联行、戴德梁行、高力国际的公开报告及安居客、搜狐租房行情。**原始报告标题、发布日期与访问日期未留存**，故降级为背景证据。用于片区级更新潜力排序（§4.2）与经济落差判断（§3.4），**不得下沉到地块或单体决策** |
...
| 13 | 22@Poblenou（巴塞罗那） | **C** | 居民协会前负责人称计划抹掉街区大部分小工业；十年房价每㎡涨近 3000 欧元 | **转述自二手媒体，原始房产研究未核。** 口径（成交价／挂牌价、区域边界）不明。仅用于说明绅士化风险方向，**不作为量化依据** |
...
| 21 | 北京人工智能公共算力调度平台 | 由多方协同建设中 | 公开信息；**出处未留存** |
